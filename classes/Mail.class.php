<?php
	...
	class Mail{
		...
		public $opt,$mailer;
		public $email = 'mdgomes.net@hotmail.com';//Trocar e-mail aqui!
		public $senha = 'mdgomes2013';//Trocar senha aqui!
		...
		public function __construct(Array $parametros){
			...
			$this->mailer->IsSMTP();
			$this->mailer->Host = 'https://app.netlify.com/'; //SERVIDOR SMTP DA HOSPEDAGEM
